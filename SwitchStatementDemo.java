...
public class SwitchStatementDemo{
    public static void main(String[] args) {
        ...
        String operator_instruction = "Operations available:\n1 -> Add\n2 -> Subtract\n3 -> Multiply\n4 -> Divide\n5 -> Square of n\n6 -> Root of n\n7 -> Exit program\n";
        ...
        while (true) {
            ...
            switch (operation) {
                ...
                case 5:
                    ...
                    first_operand = user_input.nextFloat();
                    System.out.println("Square of " + first_operand + " = " + (first_operand * first_operand));
                    break;
                case 6:
                    System.out.print("Enter integer: ");
                    first_operand = user_input.nextFloat();
                    System.out.println("Square root of " + first_operand + " = " + (Math.sqrt(first_operand)));
                    break;
                case 7:
